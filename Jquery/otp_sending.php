...
<div id="image-cont">
    ...
    <div id="content-cont">
      <p><h1 class="instrument-serif-regular">Hubble - Miracle's Portal for</h1></p>
      <p><h1 class="instrument-serif-regular">Enterprise Resource</h1></p>
      <p><h1 class="instrument-serif-regular">Management</h1></p>
    ...
    <div class="login-form">
        ...
        <form onsubmit="return handleButtonClick();" action="" method="post">
            ...
            <div class="form-group">
                ...
                <!-- <button id="submitButton" type="submit" class="butt">Send</button> -->
                <!-- <button id="sendButton" type="submit" class="butt" ><p id="spinner" class="spinner"></p>Send</button> -->

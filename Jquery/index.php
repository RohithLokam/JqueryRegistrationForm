  ...
  <div id="login-container">
    ...
    <div class="login-form">
        ...
        <form action="" method="post">
            ...
            <img class="eye" src="https://clipground.com/images/password-eye-icon-png-2.png" width="9%" height="14%" style="z-index:3; margin-left: 88%; margin-top:-16%; display:inline; vertical-align: middle; position:relative;" id="tp">
            <p style="text-align: right; margin-top:-5px; margin-bottom:-5px;" class="text-center small"> <a href="otp_sending.php">Forgot Password</a></p>
            ...
            <p class="text-center small"><b>Don't have an account? <a href="registration_form.php">Sign up</a></b></p>
        </form>
    </div>
    </div>
</body>

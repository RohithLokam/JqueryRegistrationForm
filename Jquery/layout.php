      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent" style="z-index:10089;">
        ...
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            ...
            <a class="nav-link" href="home.php"><i class="fa fa-fw fa-home"></i><b> Home</b><span
        ...
        <a class="nav-link" href="registration_form.php"><i class="fa fa-fw fa-plus"></i><b>Register</b><span class="sr-only">(current)</span></a>
          ...
          <li class="nav-item">
            <a class="nav-link" href="practice.php"><i class="fa fa-fw fa-list"></i><b>Employ Data</b><span
                class="sr-only">(current)</span></a>
          </li>

          <li class="nav-item menus">
            <a class="nav-link " href="profile.php?employId=<?= json_encode($employId); ?>"><i
                class="fs-13 fa fa-user"></i> Profile<span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item menus">
            <a class="nav-link" href="password_reset.php"><i class="fa fa-outdent"></i> Reset Password<span
                class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item menus">
            <a class="nav-link" href="logout.php"><i class="fa fa-power-off"></i> Log Out<span
                class="sr-only">(current)</span></a>
          </li>
...
?>
          ...
          <div class="pname">
            <h3>
              <p style="color:black;" id="proff">User Name</p>
            </h3>
  ...
  <div class="foot">
    <footer>
      ...
      <p style="color:white;">@Miracle Software Systems 2024.</p>

  ...
  <div id="login-container">
    ...
    <div class="login-form">
        ...
        <form onsubmit="return validPasswords();" action="" method="post">
            <input type="password" id="userName" class="form-control" name="username" placeholder="New Password" ><br>
            <p style="color:red;" id="uname"></p>
            <input type="password" id="password" class="form-control" name="password" placeholder="Confirm Password" ><br>
...
function validPasswords() {
        ...
        if(newPassword==="" && confirmPassword===""){
            $('#passwd').html("Fields Can't Be Empty!");
            return false; 
        }
        else if (newPassword !== confirmPassword) {
            $('#passwd').html("Does Not Match With New Password!");
            return false; 
        } else {
            $('#uname').html("");
            $('#passwd').html("");

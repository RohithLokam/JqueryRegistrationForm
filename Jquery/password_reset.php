...
<body>
    <div class="register">
        ...
        <form action="" method="post" onsubmit="return validateForm()">
            ...
            <img src="https://clipground.com/images/password-eye-icon-png-2.png" width="9%" height="14%" style="z-index:3; margin-left: 57.6%; margin-top:-27%; display:inline; vertical-align: middle;" id="tp1">
            <p  id="oldpasswordMessage"></p>
            <label>NewPassword: </label><br>
            <input type="password" id="newpassword" name="newpassword" placeholder="Enter new password" >
            <img src="https://clipground.com/images/password-eye-icon-png-2.png" width="9%" height="14%" style="z-index:3; margin-left: 57.6%; margin-top:-27%; display:inline; vertical-align: middle;" id="tp2">
            ...
            <img src="https://clipground.com/images/password-eye-icon-png-2.png" width="9%" height="14%" style="z-index:3; margin-left: 57.6%; margin-top:-27%; display:inline; vertical-align: middle;" id="tp3">
